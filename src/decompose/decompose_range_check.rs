...
use halo2_proofs::{
    ...
    plonk::{Assigned, ConstraintSystem, Error, TableColumn},
};
...
#[derive(Debug, Clone)]
struct DecomposeConfig<F: FieldExt, const NUM_BITS: usize> {
...
impl<F: FieldExt, const NUM_BITS: usize> DecomposeConfig<F, NUM_BITS> {
    fn configure(meta: &mut ConstraintSystem<F>) -> Self {
